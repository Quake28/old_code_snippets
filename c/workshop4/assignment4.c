...
int main()
{
           ...
           (strcmp(cont, "y") == 0))
    {
        ...
        printf("\nRobots capable of being used for a robotics competition with "
               "Trial_speed of %f (m/s):\n",
               Trial_speed);
        printf("-------------------------------------------------------------------"
               "---------");
        int count = 0;
        ...
        for (int j = 0; j < i; j++)
        {
            if (i == 0)
            {
                printf("No robots is capable of being used for the robotics "
        ...
        printf("-------------------------------------------------------------------"
               "---------\n");
        printf("A total of %i robots are capable of being used for the robotics "
               "competition scenario\n",
               count);
